...
public class Constants {
    ...
    public static final String EMBEDDED_HOST_DEFAULT = "http://10.0.0.154";
    public static final String EMBEDDED_USER = "embedded_user";
    public static final String EMBEDDED_USER_DEFAULT = "root";
    public static final String EMBEDDED_PASSWORD = "embedded_password";
    public static final String EMBEDDED_PASSWORD_DEFAULT = "doghunter";
